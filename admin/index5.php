                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<tr>
                                ...
                                <td><button class='btn btn-primary' onclick='confirmChangeAccountType({$row['userID']})'>Change Account Type</button></td>
                              </tr>";
                    }
                }
                ?>
...
<script>
    ...
    // Function to confirm the change of account type
    function confirmChangeAccountType(userID) {
        Swal.fire({
            title: 'Are you sure?',
            text: 'You are about to change the account type!',
            icon: 'warning',
